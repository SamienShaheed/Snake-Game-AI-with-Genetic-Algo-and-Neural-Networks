class NeuralNet {
  ...
  NeuralNet(int input, int hidden, int output, int hiddenLayers) {
    iNodes = input; // Initial number of input layer neurons
    hNodes = hidden; // Number of neurons in each hidden layer
    oNodes = output; // Number of neurons in the output layer
    hLayers = hiddenLayers; // Number of hidden layers
